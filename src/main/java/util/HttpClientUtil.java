...
public class HttpClientUtil {
    ...
    static {
        try {
            ...
            sslsf = new SSLConnectionSocketFactory(builder.build(), new String[]{"TLSv1.2"}, null, NoopHostnameVerifier.INSTANCE);
    ...
    public static String get(String  url, Map<String, String> header, Map<String, String> param) throws Exception {
        ...
        try {
            ...
            HttpGet httpget = new HttpGet(url + parameters.toString());
